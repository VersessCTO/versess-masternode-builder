#!/bin/bash
# Versess Masternode Setup Script V1 for Ubuntu 18.04 LTS
#
...
wget https://github.com/VersessCTO/versess-core/releases/download/v1.0/VERS-v1.0-daemon-ubuntu_18.04.tar.gz
tar -xzvf VERS-v1.0-daemon-ubuntu_18.04.tar.gz
